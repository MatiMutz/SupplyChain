...
namespace SupplyChain.Server.Controllers
{
    ...
    public class IndicController : ControllerBase
    {
        ...
        {
            return await _context.Indics.ToListAsync();
        }
        ...
        {
            var indic = await _context.Indics.FindAsync(id);
        ...
        {
            return _context.Indics.Any(e => e.REGISTRO == id);
        }
    }
}
