...
namespace SupplyChain.Pages.Prods
{
    public class ProdsPageBase : ComponentBase
    {
        ...
        {
            prods = await Http.GetFromJsonAsync<List<Prod>>("api/Prod");

            await base.OnInitializedAsync();
        }

        public void ActionBeginHandler(ActionEventArgs<Prod> args)
        {
        ...
        public async Task ActionBegin(ActionEventArgs<Prod> args)
        {
        ...
        private async Task EliminarProd(ActionEventArgs<Prod> args)
        {
            try
            {
                if (args.Data != null)
